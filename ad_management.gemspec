...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Vincent Balbarin"]
  spec.email         = ["vincent.balbarin@yale.edu"]

  spec.summary       = %q{This gem is light wrapper for `net-ldap` Ruby. It allows for the management of MS ActiveDirectory}
